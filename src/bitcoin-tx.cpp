...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " crt-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  crt-tx [options] <hex-tx> [commands]  Update hex-encoded crt transaction\n" +
            "or:     crt-tx [options] -create [commands]   Create hex-encoded crt transaction\n" +
            "\n";
