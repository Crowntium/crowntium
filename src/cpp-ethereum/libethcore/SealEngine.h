...
////////////////////////////////////////////////////////////// // crt
    void setCrowntiumSchedule(EVMSchedule _crtSchedule) const { crtSchedule = _crtSchedule; }

    EVMSchedule& getCrowntiumSchedule() const { return crtSchedule; }
...
private:
    ...
    mutable EVMSchedule crtSchedule; // crt
