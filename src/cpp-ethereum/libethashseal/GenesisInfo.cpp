...
#include "genesis/crtMainNetwork.cpp"
...
#include "genesis/test/crtTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::crtMainNetwork: return c_genesisInfoCrowntiumMainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::crtTestNetwork: return c_genesisInfoCrowntiumTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::crtMainNetwork: return c_genesisStateRootCrowntiumMainNetwork;
    case Network::crtTestNetwork: return c_genesisStateRootCrowntiumTestNetwork;
