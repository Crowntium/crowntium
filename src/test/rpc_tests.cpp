...
BOOST_AUTO_TEST_CASE(rpc_format_monetary_values)
{
    ...
    BOOST_CHECK(ValueFromAmount(1000000000024999990LL).write() == "10000000000.24999990");
    BOOST_CHECK(ValueFromAmount(1000000000024999999LL).write() == "10000000000.24999999");
    BOOST_CHECK(ValueFromAmount(1000000000025000000LL).write() == "10000000000.25000000");
...
BOOST_AUTO_TEST_CASE(rpc_parse_monetary_values)
{
    ...
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("10000000000.2499999")), 1000000000024999990LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("10000000000.24999999")), 1000000000024999999LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("10000000000.25")), 1000000000025000000LL);
