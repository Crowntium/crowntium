...
//    initState();
    ...
    std::vector<CrowntiumTransaction> txBtcEcrecover;
    txBtcEcrecover.push_back(createCrowntiumTransaction(CODE[1], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createCrowntiumTransaction(CODE[2], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createCrowntiumTransaction(CODE[3], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createCrowntiumTransaction(CODE[4], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
