...
UniValue blockheaderToJSON(const CBlockIndex* tip, const CBlockIndex* blockindex)
{
    ...
    result.pushKV("hashStateRoot", blockindex->hashStateRoot.GetHex()); // crt
    result.pushKV("hashUTXORoot", blockindex->hashUTXORoot.GetHex()); // crt

    if(blockindex->IsProofOfStake()){
        result.pushKV("prevoutStakeHash", blockindex->prevoutStake.hash.GetHex()); // crt
        result.pushKV("prevoutStakeVoutN", (int64_t)blockindex->prevoutStake.n); // crt
    }
...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* tip, const CBlockIndex* blockindex, bool txDetails)
{
    ...
    result.pushKV("hashStateRoot", block.hashStateRoot.GetHex()); // crt
    result.pushKV("hashUTXORoot", block.hashUTXORoot.GetHex()); // crt
...
static std::vector<RPCResult> MempoolEntryDescription() { return {
    ...
    RPCResult{RPCResult::Type::NUM, "size", "(DEPRECATED) same as vsize. Only returned if crtd is started with -deprecatedrpc=size\n"
...
UniValue getdelegationinfoforaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"getdelegationinfoforaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The crt address string"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
    ...
    CrowntiumDelegation crtDelegation;
    Delegation delegation;
    uint160 address = uint160(*pkhash);
    if(!crtDelegation.GetDelegation(address, delegation)) {
        throw JSONRPCError(RPC_INTERNAL_ERROR, "Failed to get delegation");
    }
    bool verified = crtDelegation.VerifyDelegation(address, delegation);
...
UniValue getdelegationsforstaker(const JSONRPCRequest& request)
{
            RPCHelpMan{"getdelegationsforstaker",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The crt address string for staker"},
                },
               RPCResult{
            RPCResult::Type::ARR, "", "",
                {
    ...
    if(!crtDelegation.FilterDelegationEvents(events, filter)) {
        throw JSONRPCError(RPC_INTERNAL_ERROR, "Failed to get delegations for staker");
    }
    std::map<uint160, Delegation> delegations = crtDelegation.DelegationsFromEvents(events);
                        ...
                        {RPCResult::Type::OBJ, "scriptPubKey", "",
                            {
                                ...
                                {RPCResult::Type::ARR, "addresses", "array of crt addresses",
                                    {{RPCResult::Type::STR, "address", "crt address"}}},
                            }},
...
static UniValue crt20name(const JSONRPCRequest& request)
{
            RPCHelpMan{"crt20name",
                ...
                RPCExamples{
                    HelpExampleCli("crt20name", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
            + HelpExampleRpc("crt20name", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
                },
            }.Check(request);
...
static UniValue crt20symbol(const JSONRPCRequest& request)
{
            RPCHelpMan{"crt20symbol",
                ...
                RPCExamples{
                    HelpExampleCli("crt20symbol", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
            + HelpExampleRpc("crt20symbol", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
                },
            }.Check(request);
...
static UniValue crt20totalsupply(const JSONRPCRequest& request)
{
            RPCHelpMan{"crt20totalsupply",
                ...
                RPCExamples{
                    HelpExampleCli("crt20totalsupply", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
            + HelpExampleRpc("crt20totalsupply", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
                },
            }.Check(request);
...
static UniValue crt20decimals(const JSONRPCRequest& request)
{
            RPCHelpMan{"crt20decimals",
                ...
                RPCExamples{
                    HelpExampleCli("crt20decimals", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
            + HelpExampleRpc("crt20decimals", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
                },
            }.Check(request);
...
static UniValue crt20balanceof(const JSONRPCRequest& request)
{
            RPCHelpMan{"crt20balanceof",
                "\nReturns the token balance for address\n",
                {
                    {"contractaddress", RPCArg::Type::STR_HEX, RPCArg::Optional::NO, "The contract address"},
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO,  "The crt address to check token balance"},
                },
                RPCResult{
                    RPCResult::Type::STR, "balance", "The token balance of the chosen address"},
                RPCExamples{
                    HelpExampleCli("crt20balanceof", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\"")
            + HelpExampleRpc("crt20balanceof", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\"")
                },
            }.Check(request);
...
static UniValue crt20allowance(const JSONRPCRequest& request)
{
            RPCHelpMan{"crt20allowance",
                "\nReturns remaining tokens allowed to spend for an address\n",
                {
                    {"contractaddress", RPCArg::Type::STR_HEX, RPCArg::Optional::NO, "The contract address"},
                    {"addressFrom", RPCArg::Type::STR, RPCArg::Optional::NO,  "The crt address of the account owning tokens"},
                    {"addressTo", RPCArg::Type::STR, RPCArg::Optional::NO,  "The crt address of the account able to transfer the tokens"},
                },
                RPCResult{
                    RPCResult::Type::STR, "allowance", "Amount of remaining tokens allowed to spent"},
                RPCExamples{
                    HelpExampleCli("crt20allowance", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\" \"QM72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\"")
            + HelpExampleRpc("crt20allowance", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\" \"QM72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\"")
                },
            }.Check(request);
...
static UniValue crt20listtransactions(const JSONRPCRequest& request)
{
            RPCHelpMan{"crt20listtransactions",
                "\nReturns transactions history for a specific address.\n",
                {
                    {"contractaddress", RPCArg::Type::STR_HEX, RPCArg::Optional::NO, "The contract address."},
                    {"addresss", RPCArg::Type::STR, RPCArg::Optional::NO,  "The crt address to get history for."},
            ...
            RPCResult::Type::ARR, "", "",
                {
                    {RPCResult::Type::OBJ, "", "",
                        {
                            {RPCResult::Type::STR, "receiver", "The receiver crt address"},
                            {RPCResult::Type::STR, "sender", "The sender crt address"},
                ...
                RPCExamples{
                    HelpExampleCli("crt20listtransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\"")
            + HelpExampleCli("crt20listtransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\" 0 6")
            + HelpExampleRpc("crt20listtransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\"")
            + HelpExampleRpc("crt20listtransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\" 0 6")
                },
            }.Check(request);
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    { "blockchain",         "crt20name",              &crt20name,              {"address"} },
    { "blockchain",         "crt20symbol",            &crt20symbol,            {"address"} },
    { "blockchain",         "crt20totalsupply",       &crt20totalsupply,       {"address"} },
    { "blockchain",         "crt20decimals",          &crt20decimals,          {"address"} },
    { "blockchain",         "crt20balanceof",         &crt20balanceof,         {"contractaddress", "address"} },
    { "blockchain",         "crt20allowance",         &crt20allowance,         {"contractaddress", "addressFrom", "addressTo"} },
    { "blockchain",         "crt20listtransactions",  &crt20listtransactions,  {"contractaddress", "address", "startblock", "minconf"} },
