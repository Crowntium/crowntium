...
bool FirstPrime(Integer &p, const Integer &max, const Integer &equiv, const Integer &mod, const PrimeSelector *pSelector)
{
	...
	if (mod.IsOdd())
		return FirstPrime(p, max, XCRT(equiv, mod, 1, 2, 1), mod<<1, pSelector);
...
Integer XCRT(const Integer &xp, const Integer &p, const Integer &xq, const Integer &q, const Integer &u)
{
