...
/**
 * @brief The CrowntiumLedger class Communicate with the crt ledger
 */
class CrowntiumLedger {
    
public:
    /**
     * @brief CrowntiumLedger Constructor
     */
    CrowntiumLedger();

    /**
     * @brief ~CrowntiumLedger Destructor
     */
    virtual ~CrowntiumLedger();
     ...
     * @return
     */
    static CrowntiumLedger &instance();
...
private:
    CrowntiumLedger(const CrowntiumLedger&);
    CrowntiumLedger& operator=(const CrowntiumLedger&);
    CrowntiumLedgerPriv* d;
};
#endif
