#ifndef XCRTDELEGATION_H
#define XCRTDELEGATION_H
#include <string>
#include <vector>
#include <map>
#include <stdint.h>
...
/**
 * @brief The ICrowntiumStaker class Delegation filter
 */
...
/**
 * @brief The CrowntiumDelegation class Communicate with the crt delegation contract
 */
class CrowntiumDelegation {
    
public:
    /**
     * @brief CrowntiumDelegation Constructor
     */
    CrowntiumDelegation();

    /**
     * @brief ~CrowntiumDelegation Destructor
     */
    virtual ~CrowntiumDelegation();
...
private:
    CrowntiumDelegation(const CrowntiumDelegation&);
    CrowntiumDelegation& operator=(const CrowntiumDelegation&);
    CrowntiumDelegationPriv* priv;
};
#endif
