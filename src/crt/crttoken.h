...
public:
    ...
    virtual ~CrowntiumTokenExec();
};

class CrowntiumToken
{
public:
    CrowntiumToken();
    virtual ~CrowntiumToken();

    void setCrowntiumTokenExec(CrowntiumTokenExec* tokenExec);
    ...
    // Static functions
    static bool ToHash160(const std::string& strCrowntiumAddress, std::string& strHash160);
    static bool ToCrowntiumAddress(const std::string& strHash160, std::string& strCrowntiumAddress);
...
private:
    ...
    CrowntiumToken(CrowntiumToken const&);
    CrowntiumToken& operator=(CrowntiumToken const&);

private:
    CrowntiumTokenData* d;
};
