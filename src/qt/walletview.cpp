    ...
    walletFrame(qobject_cast<WalletFrame*>(parent))
{
    ...
    QPushButton *exportButton = new CrowntiumPushButton(tr("&Export"), this);
    ...
    XCRTTokenPage = new XCRTToken(platformStyle);
    ...
    // Pass through messages from XCRTTokenPage
    connect(XCRTTokenPage, &XCRTToken::message, this, &WalletView::message);
...
void WalletView::setClientModel(ClientModel *_clientModel)
{
    ...
    XCRTTokenPage->setClientModel(_clientModel);
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    XCRTTokenPage->setModel(_walletModel);
...
{
    setCurrentWidget(XCRTTokenPage);
}
