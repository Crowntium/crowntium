...
class CrowntiumStyle : public QProxyStyle
{
public:
    CrowntiumStyle()
    {
...
void StyleSheet::setStyleSheet(QApplication *app, const QString& style_name)
{
    ...
    CrowntiumStyle* crtStyle = new CrowntiumStyle;
    crtStyle->setBaseStyle(mainStyle);
    app->setStyle(crtStyle);
...
{
    return QStringList() << "Light gold theme" << "Dark blue theme" << "Dark theme";
}
