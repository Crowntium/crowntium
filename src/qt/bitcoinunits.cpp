...
QString BitcoinUnits::longName(int unit)
{
    ...
    case uBTC: return QString::fromUtf8("μXCRT (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Crowntiums");
    case mBTC: return QString("Milli-Crowntiums (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Crowntiums (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
