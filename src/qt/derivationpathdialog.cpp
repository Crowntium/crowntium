    ...
    ui(new Ui::DerivationPathDialog)
{
    ...
    ui->txtLegacy->setText(CrowntiumHwiTool::derivationPathPKH());
    ui->txtLegacy->setPlaceholderText(CrowntiumHwiTool::derivationPathPKH());
    ...
    ui->txtP2SH->setText(CrowntiumHwiTool::derivationPathP2SH());
    ui->txtP2SH->setPlaceholderText(CrowntiumHwiTool::derivationPathP2SH());
    ...
    ui->txtSegWit->setText(CrowntiumHwiTool::derivationPathBech32());
    ui->txtSegWit->setPlaceholderText(CrowntiumHwiTool::derivationPathBech32());
