#ifndef XCRTVERSIONCHECKER_H
#define XCRTVERSIONCHECKER_H

#include <QObject>

#define XCRT_RELEASES "https://github.com/crowntium/crt/releases"
...
class CrowntiumVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit CrowntiumVersionChecker(QObject *parent = 0);
    ~CrowntiumVersionChecker();
