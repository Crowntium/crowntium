#ifndef XCRTHWITOOL_H
#define XCRTHWITOOL_H
...
/**
 * @brief The CrowntiumHwiTool class Communicate with the Crowntium Hardware Wallet Interface Tool
 */
class CrowntiumHwiTool : public QObject
{
    Q_OBJECT
public:
    /**
     * @brief CrowntiumHwiTool Constructor
     * @param parent Parent object
     */
    explicit CrowntiumHwiTool(QObject *parent = nullptr);

    /**
     * @brief ~CrowntiumHwiTool Destructor
     */
    ~CrowntiumHwiTool();
