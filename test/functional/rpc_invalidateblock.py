...
from test_framework.address import ADDRESS_BXCRT1_UNSPENDABLE_DESCRIPTOR
...
class InvalidateTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        blocks = self.nodes[1].generatetodescriptor(10, ADDRESS_BXCRT1_UNSPENDABLE_DESCRIPTOR)
