...
from test_framework.address import ADDRESS_BXCRT1_UNSPENDABLE as ADDRESS_WATCHONLY
...
from test_framework.crtconfig import INITIAL_BLOCK_REWARD, COINBASE_MATURITY
