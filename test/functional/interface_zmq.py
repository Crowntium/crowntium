...
from test_framework.address import ADDRESS_BXCRT1_UNSPENDABLE
...
class ZMQTest (BitcoinTestFramework):
    ...
    def test_basic(self):
        ...
        genhashes = self.nodes[0].generatetoaddress(num_blocks, ADDRESS_BXCRT1_UNSPENDABLE)
    ...
    def test_reorg(self):
        ...
        self.nodes[1].generatetoaddress(2, ADDRESS_BXCRT1_UNSPENDABLE)
