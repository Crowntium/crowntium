...
from test_framework.crtconfig import ENABLE_REDUCED_BLOCK_TIME

import sys


RPC_INVALID_PARAMETER = -8
class CrowntiumRPCSearchlogsTestModified(BitcoinTestFramework):
...
if __name__ == '__main__':
    CrowntiumRPCSearchlogsTestModified().main()